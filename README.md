...
1) Cree una base de datos (puede ser local) que debe contener una tabla llamada "fraudes" con la información contenida en el archivo csv

2) Explore la data de fraudes con sql con almenos 3 consultas que le ayuden a generar insigths iniciales interesantes. Al menos una de estas consultas debe ser realizada con window functions. No se admiten subconsultas.
